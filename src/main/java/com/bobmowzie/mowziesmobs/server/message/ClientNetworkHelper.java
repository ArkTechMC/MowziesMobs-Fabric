    ...
    public static void register() {
        ...
        ClientPlayNetworking.registerGlobalReceiver(StaticVariables.FREEZE_EFFECT, (client, handler, buf, responseSender) -> {
            ...
            client.execute(() -> {
                ...
                Entity entity = client.world.getEntityById(message.getEntityID());
        ...
        ClientPlayNetworking.registerGlobalReceiver(StaticVariables.INTERRUPT_ABILITY, (client, handler, buf, responseSender) -> {
            ...
            client.execute(() -> {
                assert client.world != null;
                LivingEntity entity = (LivingEntity) client.world.getEntityById(message.getEntityID());
                if (entity != null) {
                    ...
                    if (abilityCapability != null) {
                        ...
                        if (instance != null && instance.isUsing()) instance.interrupt();
                    }
                }
            });
        });
        ...
        ClientPlayNetworking.registerGlobalReceiver(StaticVariables.UPDATE_BOSS_BAR, (client, handler, buf, responseSender) -> {
            ...
            client.execute(() -> {
                if (message.getRegistryName() == null) ClientProxy.bossBarRegistryNames.remove(message.getBossID());
                else ClientProxy.bossBarRegistryNames.put(message.getBossID(), message.getRegistryName());
            });
        });
