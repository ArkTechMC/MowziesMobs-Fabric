...
public class GrottolKillFortuneTrigger extends MMTrigger<AbstractCriterionConditions, GrottolKillFortuneTrigger.Listener> {
    public static final Identifier ID = new Identifier(MowziesMobs.MODID, "kill_grottol_fortune");
