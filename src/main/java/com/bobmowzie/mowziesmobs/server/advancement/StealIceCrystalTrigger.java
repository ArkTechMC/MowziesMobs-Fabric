...
public class StealIceCrystalTrigger extends MMTrigger<AbstractCriterionConditions, StealIceCrystalTrigger.Listener> {
    public static final Identifier ID = new Identifier(MowziesMobs.MODID, "steal_ice_crystal");
