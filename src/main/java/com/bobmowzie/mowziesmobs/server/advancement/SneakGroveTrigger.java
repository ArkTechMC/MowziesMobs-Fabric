...
public class SneakGroveTrigger extends MMTrigger<AbstractCriterionConditions, SneakGroveTrigger.Listener> {
    public static final Identifier ID = new Identifier(MowziesMobs.MODID, "sneak_grove");
