...
public class ModelAxeAttack<T extends EntityAxeAttack> extends AdvancedModelBase<T> {
    ...
    public ModelAxeAttack() {
        ...
        this.setRotateAngle(this.axeBladeRight3, 0.0F, 0.0F, 2.6179938779914944F);
        ...
        this.setRotateAngle(this.axeBladeRight, 0.0F, -0.7853981633974483F, 0.0F);
        ...
        this.setRotateAngle(this.axeBladeLeft, 0.0F, -3.9269908169872414F, 0.0F);
        ...
        this.setRotateAngle(this.axeBladeLeft3, 0.0F, 0.0F, 2.6179938779914944F);
        ...
        this.setRotateAngle(this.axeBladeRight2, 0.0F, 0.0F, 0.5235987755982988F);
        ...
        this.setRotateAngle(this.axeBladeLeft2, 0.0F, 0.0F, 0.5235987755982988F);
        ...
        this.axeBase.rotationPointY += 18f;
        this.axeBase.rotateAngleX -= Math.PI / 2;
        this.axeHandle.rotateAngleY += Math.PI / 4;
        this.axeHandle.rotationPointX -= 3;
        this.axeHandle.rotationPointY -= 6;
    ...
    @Override
    public void setAngles(T entityIn, float limbSwing, float limbSwingAmount, float frame, float netHeadYaw, float headPitch) {
        ...
        if (!entityIn.getVertical()) {
            ...
            float handFlip = entityIn.getCaster().getMainArm() == Arm.RIGHT ? 1 : -1;
            this.axeBase.rotateAngleY -= handFlip * swingArc * 1 / (1 + Math.exp(1.3f * (-frame + EntityAxeAttack.SWING_DURATION_HOR / 2f)));
            this.axeBase.rotateAngleY += handFlip * swingArc / 2;
            ...
            this.axeHandle.rotateAngleY -= Math.PI / 2;
            this.axeBase.rotateAngleX += -2 + 2 * animCurve;
