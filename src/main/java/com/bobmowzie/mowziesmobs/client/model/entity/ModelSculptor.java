...
public class ModelSculptor extends MowzieGeoModel<EntitySculptor> {
    ...
    private void skirtCorrections(EntitySculptor entity) {
        ...
        skirtFront.addPos(0.5f * (float) skirtLocFrontR.getModelPosition().add((Vector3dc) skirtFrontDiff.multiply(0.5)).x(), 0, 0);
        ...
        skirtBack.addPos(0.5f * (float) skirtLocBackR.getModelPosition().add((Vector3dc) skirtBackDiff.multiply(0.5)).x(), 0, 0);
